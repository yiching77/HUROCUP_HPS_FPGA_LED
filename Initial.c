...
void Initial::initial_memory_mapping()
{
	...
	//Motor Feedback data right
	p2h_set_hps_read_motor_data_rightfoot_addr = virtual_base + ( ( unsigned long  )( ALT_LWFPGASLVS_OFST + SET_HPS_READ_MOTOR_DATA_RF_BASE ) & ( unsigned long)( HW_REGS_MASK ) );
