...
friend double   num2double(const fVector &, int i); // get want elem to double    	
...
public:
	...
	void	Getelem(Float *elem) const;
	void	Setelem(Float *elem) const;
	Float   receiveelem(int i) const;
	int	Getsize() const;
